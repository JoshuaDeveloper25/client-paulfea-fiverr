            ...
            <div className="relative p-4 w-full mx-auto mt-20 max-w-xl max-h-full z-40">
              ...
              <div className="relative bg-white rounded-lg shadow text-black z-40">
                ...
                <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                  ...
                  <button
                    type="button"
                    className="shadow-lg text-black bg-transparent hover:bg-gray-200 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-black dark:hover:text-white"
